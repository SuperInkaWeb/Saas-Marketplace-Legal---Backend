-- Sincronización final de metadatos para la plantilla NDA_STANDARD (V16 para asegurar ejecución)
-- Esta migración asegura que el cuestionario pida los 5 campos detectados en la plantilla real
